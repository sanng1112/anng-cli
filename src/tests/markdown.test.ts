...
test("renderMarkdownSegments renders CJK table cells within the requested width", () => {
  const table = [
    ...
    "|---|---|---|---|",
    "| 1 | ✅ | Write code | This is a very long note used to verify that table cells wrap automatically when the terminal width is insufficient instead of overflowing |",
  ].join("\n");
