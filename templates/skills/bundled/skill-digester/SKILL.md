...
2. Infer the user's preferred language before reviewing.
   ...
   - Confirm the language with `AskUserQuestion` in the inferred language. For Chinese, ask: `Please select your preferred language.`
...
```json
{"questions":[{"question":"Please select your preferred language.","options":[{"label":"Chinese","description":"Use Chinese for follow-up questions and descriptions."},{"label":"English","description":"Use English for follow-up questions and the recommended description."}]}]}
```
