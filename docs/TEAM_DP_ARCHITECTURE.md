...
- **Full Harness & Tools:** Các Node trong `/team-wf` không bị "mù". Chúng được cấp đầy đủ quyền đọc/ghi file, duyệt thư mục, chạy terminal (`go test`, `go build`, v.v.) thông qua Tool Executor.
