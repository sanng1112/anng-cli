...
**Goal:** Rewrite `README.md` in Vietnamese to clearly detail the advanced capabilities of this enhanced version of ANNG CLI CLI, showcasing its differences from the original repository (such as the autonomous execution harness, headless task queue, optimized PDF/stream parsing, and concurrent test runner).
