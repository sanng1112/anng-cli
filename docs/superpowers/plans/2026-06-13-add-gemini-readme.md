...
Deep Code CLI hỗ trợ chạy trực tiếp với các mô hình của dòng **Google Gemini** (ví dụ: `gemini-3.5-flash`, `gemini-3.1-flash-lite`, `gemini-2.5-flash`, `gemini-2.5-flash-lite`) thông qua API tương thích với cấu trúc của OpenAI. 
